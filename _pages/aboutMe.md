...
As an engineering, I (obviously) have a deep passion (maybe obsession?) for coffee. My 3 coffees a day have given me lots of opportunities to practice and have fun with latte art, but its still a work in progress. After learning to make the tulip (top left) and the rosetta (top right), I have recently been working on the Swan (bottom row)!
...
<div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 10px; margin-top: 15px;">
  <!-- Row 1 -->
  <img src="../images/cafe0.jpg" alt="Tulip" style="width: 100%; aspect-ratio: 4/3; object-fit: cover; border: 1px solid #ccc; border-radius: 8px;">
  <img src="../images/cafe4.jpg" alt="Rosetta 1" style="width: 100%; aspect-ratio: 4/3; object-fit: cover; border: 1px solid #ccc; border-radius: 8px;">
  <img src="../images/cafe3.jpg" alt="Rosetta 2" style="width: 100%; aspect-ratio: 4/3; object-fit: cover; border: 1px solid #ccc; border-radius: 8px;">

  <!-- Row 2 : Swans-->
  <img src="../images/cafe7.jpg" alt="Swan 1" style="width: 100%; aspect-ratio: 4/3; object-fit: cover; border: 1px solid #ccc; border-radius: 8px;">
  <img src="../images/cafe8.jpg" alt="Swan 2" style="width: 100%; aspect-ratio: 4/3; object-fit: cover; border: 1px solid #ccc; border-radius: 8px;">
...
I tend to write down special quotes that have transformed the way I think, so here's a list of my favorite ones:
  - Success is the ability to go from failure to failure without a loss of enthusiasm. - Often attributed to Winston Churchill
  - Un événement est aussi important que l'importance qu'on lui accorde. - Author: unknown
  ...
  - The difference between rejection and results is how long you stick with it. - Hayes Barnard